...
export function RuntimeServicesJsonField({
  ...
  return (
    <Field label={t("agentConfig.runtimeServicesJson")} hint={help.runtimeServicesJson}>
      <textarea
...
export function PayloadTemplateJsonField({
  ...
  return (
    <Field label={t("agentConfig.payloadTemplateJson")} hint={help.payloadTemplateJson}>
      <textarea
