    ...
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          {hasActiveInvite
            ? t("app.bootstrap.activeInvite")
            : t("app.bootstrap.noInvite")}
        </p>
...
function OnboardingRoutePage() {
  ...
  const title = matchedCompany
    ? t("app.onboarding.addAnotherAgent", { companyName: matchedCompany.name })
    : companies.length > 0
  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        ...
        <div className="mt-4">
          <Button onClick={() => openOnboarding()}>{t("app.noCompanies.action")}</Button>
        </div>
      </div>
    </div>
  );
