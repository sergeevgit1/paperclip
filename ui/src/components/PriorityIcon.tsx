...
import { displayPriority } from "@/lib/display";

const priorityConfig: Record<string, { icon: typeof ArrowUp; color: string; label: string }> = {
  critical: { icon: AlertTriangle, color: priorityColor.critical ?? priorityColorDefault, label: displayPriority("critical") },
  high: { icon: ArrowUp, color: priorityColor.high ?? priorityColorDefault, label: displayPriority("high") },
  medium: { icon: Minus, color: priorityColor.medium ?? priorityColorDefault, label: displayPriority("medium") },
  low: { icon: ArrowDown, color: priorityColor.low ?? priorityColorDefault, label: displayPriority("low") },
};
